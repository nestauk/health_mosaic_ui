<!-- ionicons/dist/ionicons/svg/ios-trash.svg -->
...
>
  <g>
    ...
    <g>
      ...
      <polygon points="320,160 305.4,160 294.7,401 309.3,401 		" fill="#333" />
      <polygon points="206.5,160 192,160 202.7,401 217.3,401 		" fill="#333" />
    </g>
  </g>
</svg>
